...
export default defineContentScript({
    ...
    main() {
        ...
        // const manageBtn = document.getElementById("team_manager_button");
        ...
        function handleKeyPress(ev, arr, key) {
            if (key === arr[1].toUpperCase()) exitBtn.click();
        ...
        function showPlayerList() {
            ...
            if (players.length === 0) {
                ...
                for (let player of players) {
                    ...
                    if (isCaptain()) addPlayer(plListLi);
                }
